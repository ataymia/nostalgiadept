...
// Mock order data
const mockOrders = [
  { id: 'ND-001', date: '2024-01-15', customer: 'John Doe', email: 'john@example.com', total: 89.97, status: 'shipped', items: 3 },
  { id: 'ND-002', date: '2024-01-15', customer: 'Jane Smith', email: 'jane@example.com', total: 45.99, status: 'processing', items: 2 },
  { id: 'ND-003', date: '2024-01-14', customer: 'Bob Wilson', email: 'bob@example.com', total: 124.50, status: 'delivered', items: 5 },
  { id: 'ND-004', date: '2024-01-14', customer: 'Alice Brown', email: 'alice@example.com', total: 34.99, status: 'pending', items: 1 },
  { id: 'ND-005', date: '2024-01-13', customer: 'Charlie Davis', email: 'charlie@example.com', total: 67.98, status: 'cancelled', items: 2 },
];
